...
pkgdatadir = $(datadir)/globes
pkgincludedir = $(includedir)/globes
pkglibdir = $(libdir)/globes
pkglibexecdir = $(libexecdir)/globes
...
am__aclocal_m4_deps = $(top_srcdir)/m4/exitfail.m4 \
	$(top_srcdir)/m4/gnulib.m4 $(top_srcdir)/m4/gsl.m4 \
	$(top_srcdir)/m4/inttypes_h.m4 $(top_srcdir)/m4/libtool.m4 \
	$(top_srcdir)/m4/ltoptions.m4 $(top_srcdir)/m4/ltsugar.m4 \
	$(top_srcdir)/m4/ltversion.m4 $(top_srcdir)/m4/lt~obsolete.m4 \
	$(top_srcdir)/m4/obstack.m4 $(top_srcdir)/m4/rpm.m4 \
	$(top_srcdir)/m4/stdint_h.m4 $(top_srcdir)/m4/swig.m4 \
	$(top_srcdir)/m4/swig_perl.m4 $(top_srcdir)/m4/uintmax_t.m4 \
...
CONFIG_CLEAN_FILES = globes.spec examples/Makefile globes-config
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config-h.in \
	$(srcdir)/globes-config.in $(srcdir)/globes.spec.in \
...
ACLOCAL = ${SHELL} '/home/salva/Desktop/GLoBES-EFT/missing' aclocal-1.16
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} '/home/salva/Desktop/GLoBES-EFT/missing' autoconf
AUTOHEADER = ${SHELL} '/home/salva/Desktop/GLoBES-EFT/missing' autoheader
AUTOMAKE = ${SHELL} '/home/salva/Desktop/GLoBES-EFT/missing' automake-1.16
AWK = mawk
CC = gcc
...
LEXLIB = 
LEX_OUTPUT_ROOT = 
LIBOBJS =  ${LIBOBJDIR}exitfail$U.o
LIBS = -L/usr/local/lib -lgsl -lgslcblas -lm -lm 
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIPO = 
LN_S = ln -s
LTALLOCA = 
LTLIBOBJS =  ${LIBOBJDIR}exitfail$U.lo
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/home/salva/Desktop/GLoBES-EFT/missing' makeinfo
MANIFEST_TOOL = :
...
OTOOL64 = 
PACKAGE = globes
PACKAGE_BUGREPORT = globes@mpi-hd.mpg.de
PACKAGE_NAME = GLoBES
PACKAGE_STRING = GLoBES 3.2.18
PACKAGE_TARNAME = globes
PACKAGE_URL = 
...
YACC = yacc
YFLAGS = 
abs_builddir = /home/salva/Desktop/GLoBES-EFT
abs_srcdir = /home/salva/Desktop/GLoBES-EFT
abs_top_builddir = /home/salva/Desktop/GLoBES-EFT
abs_top_srcdir = /home/salva/Desktop/GLoBES-EFT
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/salva/Desktop/GLoBES-EFT/install-sh
...
globes.spec: $(top_builddir)/config.status $(srcdir)/globes.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
examples/Makefile: $(top_builddir)/config.status $(top_srcdir)/examples/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
globes-config: $(top_builddir)/config.status $(srcdir)/globes-config.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
uninstall-am: uninstall-m4dataDATA uninstall-nodist_binSCRIPTS
...
#	$(RPM_PROG) $(RPM_ARGS) --clean globes.spec
#	$(RPM_PROG) --rmsource globes.spec
#	cp $(RPM_SRPM_NAME) ./
#	cp $(RPM_TARGET) ./
#	rm -f $(RPM_SRPM_NAME)
