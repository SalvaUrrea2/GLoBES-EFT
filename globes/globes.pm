...
*smeft_glbVacuumProbability = *globesc::smeft_glbVacuumProbability;
*smeft_glbConstantDensityProbability = *globesc::smeft_glbConstantDensityProbability;
*smeft_glbProfileProbability = *globesc::smeft_glbProfileProbability;
*smeft_glbFilteredConstantDensityProbability = *globesc::smeft_glbFilteredConstantDensityProbability;
...
*glb_current_experiment = *globesc::glb_current_experiment;
